    ...
    if (fname.isdigit() or (fname == "")):
        ...
        with conn:
            ...
            cursor.execute(
                ...
                (fname, addr, un, email, mobile,age,time, pwd))
...
image2 = image2.resize((1700,1200), Image.ANTIALIAS)
