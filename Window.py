...
lbl = tk.Label(frame_alpr, text="Machine Learning Approaches On", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
lbl.place(x=150, y=180)

lbl = tk.Label(frame_alpr, text="Polycystic Ovary Syndrome", font=('Times New Roman', 30,' bold '),bg="white",fg="black")
...
logo_label1=tk.Label(text='To develop a system that capable \n Identify the type of Polycystic Ovary Syndrome  ...',compound='bottom',font=("Times New Roman", 20, 'bold', 'italic'),width=35, bg="white", fg="black")
